...
import com.mysampleapp.HomeMapFragment;
...
public class DemoConfiguration {
    ...
    static {
        ...
        addDemoFeature("report_delay", R.mipmap.usermanual, R.string.feature_report_delay_title,
                R.string.feature_report_delay_subtitle, R.string.feature_report_delay_overview,
                R.string.feature_report_delay_description, R.string.feature_sign_in_powered_by,
                new DemoItem(R.string.main_fragment_title_report_delay, R.mipmap.usermanual,
                        R.string.feature_report_delay_demo_button, HomeMapFragment.class));
